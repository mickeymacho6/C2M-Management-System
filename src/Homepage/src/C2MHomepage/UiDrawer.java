...
public class UiDrawer extends Component {
    ...
    //Placeholder strings for information banner. When homepage is linked to other pages this will be replaced by
    //to do: String = pageName.getInformationX();
...
//to do: Next step will have paint check for the resolution of the window and scale/place the UI elements appropriately
    @Override

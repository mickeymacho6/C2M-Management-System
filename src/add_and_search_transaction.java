...
public class add_and_search_transaction {
	...
	public static void main(String[] args) {
		...
		ImageIcon card2cartlogo = new ImageIcon("src/card2cartlogo.jpeg");
		...
		searchTrackingField = new JTextField();
		searchTrackingField.addKeyListener(new KeyAdapter() {
			@Override
			public void keyPressed(java.awt.event.KeyEvent e) {
				
				DefaultTableModel modelFour = (DefaultTableModel)search_class_table.getModel();
		...
		searchTrackingField.setColumns(10);
		searchTrackingField.setBounds(613, 638, 169, 20);
